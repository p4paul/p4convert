...
<xsl:stylesheet 
  ...
  <!-- ============================================================= -->
  <!-- Chinese-specific FO customizations follow                     -->
  <!-- ============================================================= -->
  ...
  <l:i18n xmlns:l="http://docbook.sourceforge.net/xmlns/l10n/1.0">
    <l:l10n language="zh_cn">
      <l:context name="xref">
        ...
        <l:template name="bridgehead" text="请参阅第 %p 页的 “%t”"/>
        <l:template name="refsection" text="请参阅第 %p 页的 “%t”"/>
        <l:template name="refsect1" text="请参阅第 %p 页的 “%t”"/>
        <l:template name="refsect2" text="请参阅第 %p 页的 “%t”"/>
        <l:template name="refsect3" text="请参阅第 %p 页的 “%t”"/>
        <l:template name="sect1" text="请参阅第 %p 页的 “%t”"/>
        <l:template name="sect2" text="请参阅第 %p 页的 “%t”"/>
        <l:template name="sect3" text="请参阅第 %p 页的 “%t”"/>
        <l:template name="sect4" text="请参阅第 %p 页的 “%t”"/>
        <l:template name="sect5" text="请参阅第 %p 页的 “%t”"/>
        <l:template name="section" text="请参阅第 %p 页的 “%t”"/>
        <l:template name="simplesect" text="请参阅第 %p 页的 “%t”"/>
      </l:context>
    </l:l10n>
  </l:i18n>
