...
public class SvnContentStream extends ContentStream {
	...
	public SvnContentStream(Content content, long length) throws IOException {
		this.contentType = content.getType();

		if (content.getLength() < length)
	...
	public SvnContentStream(Content content) throws IOException {
		this(content, content.getLength());
		setFilter(false);
	}
